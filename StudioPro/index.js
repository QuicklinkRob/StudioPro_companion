...
// 					requestData: settings
// 				}).then(response => {
// 					this.log('debug', 'Audio control settings saved successfully:', response)
// 				}).catch(error => {
// 					// Vendor doesn't support this yet - that's OK
// 					this.log('debug', 'Audio control settings vendor save not supported yet:', error.message)
// 				})
...
// 	// Debug method to check current audio control variable values
// 	debugAudioControlVariables() {
// 		const currentValues = {
// 			audio_control_source_1: this.getVariableValue('audio_control_source_1'),
// 			audio_control_source_2: this.getVariableValue('audio_control_source_2'),
// 			audio_control_source_3: this.getVariableValue('audio_control_source_3'),
// 			audio_control_source_4: this.getVariableValue('audio_control_source_4'),
// 			audio_control_type_1: this.getVariableValue('audio_control_type_1'),
// 			audio_control_type_2: this.getVariableValue('audio_control_type_2'),
// 			audio_control_type_3: this.getVariableValue('audio_control_type_3'),
// 			audio_control_type_4: this.getVariableValue('audio_control_type_4'),
// 			ip_1: this.getVariableValue('ip_1'),
// 			ip_2: this.getVariableValue('ip_2'),
// 			ip_3: this.getVariableValue('ip_3'),
// 			ip_4: this.getVariableValue('ip_4'),
...
// 		this.log('info', 'Current audio control variable values:', currentValues)
