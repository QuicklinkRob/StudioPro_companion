...
// 	// Load saved settings first, then set defaults if no saved settings exist
// 	const initializeAudioControlSettings = async () => {
// 		try {
// 			const savedSettings = await this.loadAudioControlSettings()
// 			if (savedSettings) {
// 				this.log('debug', 'Applying saved audio control settings:', savedSettings)
...
// 					scene_preview: this.states.previewScene ?? 'None',
// 					scene_active: this.states.programScene ?? 'None',
// 					...finalSettings, // Apply saved settings
// 					ipSettings: false,
// 					ip4: '',
// 					gateway: '',
// 					dns: '',
...
// 			}
// 		} catch (error) {
// 			this.log('debug', 'Failed to load saved audio control settings, using defaults:', error.message)
// 		}
		
// 		// If no saved settings or loading failed, use defaults
// 		this.setVariableValues({
// 			current_media_name: 'None',
// 			recording_file_name: 'None',
// 			replay_buffer_path: 'None',
...
// 	// Initialize settings immediately (this will be async but starts right away)
// 	initializeAudioControlSettings()
	
// 	// Debug: Show loaded values after a short delay to allow async loading
// 	setTimeout(() => {
// 		this.debugAudioControlVariables()
// 	}, 1000)
